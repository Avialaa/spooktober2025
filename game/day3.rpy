...
#FADE TO BLACK TAI JTN , TIMESKIP 
    #label C2 Cee has messed up big time

    scene bg warehouse # cee ending versio tähän 
    ...
    "What's more, some of us can't come to work anymore. There's a vampire from the collecting department who can no longer do her job because of the running water. She seems pretty stressed about it, and rightfully so."

    "Our sea creature colleagues seem happy, though. They're faster and more productive than the rest of us. In fact, I think their production levels have skyrocketed, and so has their satisfaction with work life. They all sing Cee's praises."
    ...
    "Agatha mentioned that people are already complaining about destroyed spell scrolls and mouldy magic boots. Several land-dwelling monsters are upset that their loot is now considered faulty when it doesn't do well in water."
    "It's the same as before, just with the roles reversed. Cee and the other sea monsters are now the norm, and the rest of us feel inadequate. I don't think this is what Cee had in mind when they were planning on changing things."
    ...
    C "The life of an autocrat is far from easy. I cannot please everyone. The sea creatures demanded liberation, respect, and better working conditions - of course I made those things my priority. Besides, you got your precious sand, did you not? I kept my promise!"
    C "Yeah, but it's all underwater. This is not a paradise island, Cee, this is a water dungeon!"
    ...
    C "Bah. If someone complains, I'll just… contain them in an underwater cell or something. Ha! Problem solved."
    ...
    MC "Everyone deserves to be treated with proper respect. Sea creatures, land-dwellers, slimes… EVERYONE. Things were far from perfect before and you tried your best to change them. However, I don't think this is what you wanted, was it?"
    # Cee alakuloinen

    MC "I'm not saying this corporation is just like a big, loving family or anything that cheesy. Most of us just want to go to work, make this world just a tiny bit safer of a place for us monsters, and relax after work."
    ...
    C "What makes you think that the land-dwelling masses - who, in fact, are currently rather cross with me - would not create a solution that hurts us sea creatures even more? What if they thirst for vengeance?"
    ...
    MC "Yeah?"
    C "The truth is… I wanted to be accepted, not feared. Boss is immensely popular, so I thought improving this corporation would make the uncouth masses follow me instead of him. Then no one would look down on me ever again."
    MC "Cee…"
    ...
    MC "Now now, Cee, there's no need for that. It's like ripping off a bandage. Yeah, it's gonna sting, but it IS necessary and you'll feel better afterwards. Isolation and rumination are only going to make you feel worse."
    # Cee vihainen
    ...
    MC "It's not like we can't fix this place, and I bet most folks understand that you were only trying to make things better. Besides, you don't have to do this alone. I'm the one who decided to side with you. Like you said, I'm your partner in crime."
    # Cee smiles
    ...
    A "Obviously."
    MC "...but at least they tried to improve this corporation and our working conditions. That's something we all want, right? I'm sure there's something we can do, and we must do it together. No monster left behind."
